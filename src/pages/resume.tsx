...
import GithubPhoto from "../images/social-icons/github.png";
import GitlabPhoto from "../images/social-icons/gitlab.png";
import LinkedinPhoto from "../images/social-icons/linkedin.png";
import PrinterPhoto from "../images/printer.png";
	...
	return (
		<>
			...
			<section className="shadow-md place-content-center w-[216mm] my-0 mx-auto p-4 print:p-0 print:shadow-none">
				...
				>
					<img className="w-10 mb-2" src={PrinterPhoto} alt="Printer" />
					...
					<div className="flex flex-col items-center basis-4/12">
						...
						<section className="flex items-start">
							<a
								...
								target="_blank"
							>
								<img alt="Github" src={GithubPhoto} />
							</a>
							<a
								className="h-6 w-6 mr-4"
								rel="noopener noreferrer"
								...
								target="_blank"
							>
								<img alt="Gitlab" src={GitlabPhoto} />
							</a>
							<a
								className="h-6 w-6 mr-4"
								rel="noopener noreferrer"
